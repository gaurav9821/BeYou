...
import com.beyou.setting.CountryRepository;
...
public class CustomerService {
    ...
    public boolean verify(String verificationCode){
        Customer customer = customerRepo.findByVerifiationCode(verificationCode);
    ...
    public String updateResetPasswordToke(String email) throws CustomerNotFoundException {
        Customer customer = customerRepo.findByEmail(email);
