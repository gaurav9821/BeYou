...
public class CategoryController {
    ...
    //controller for enabling and disabling the Category
    @GetMapping("/categories/{id}/enabled/{status}")
    public String updateCategoryEnabStatus(@PathVariable(name="id") Integer id ,
    ...
    //function for deleting the category from db
