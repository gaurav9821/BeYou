...
public class CategoryService {
    ...
    private List<Category> listHierarchialCategories(List<Category> rootCategories, String sortDir){
        ...
        for(Category rootCategory : rootCategories){
            ...
            for(Category subCategory : children){
                ...
                listSubHierarchialCategories(hierarchialCategories,subCategory,1,sortDir);
            }
        }
    ...
    private void listSubHierarchialCategories(List<Category> hierarchialCategories,Category parent , int subLevel,String sortDir){
        ...
        for(Category subCategory : children){
            ...
            listSubHierarchialCategories(hierarchialCategories, subCategory, newSubLevel,sortDir);
    ...
    //function used to edit category to select id from database
    ...
    //method for checking of uniqueness of category based on name and alias
    ...
    //method for sorting of subcategories
