...
import com.beyou.admin.category.CategoryService;
...
public class BrandController {
    ...
    //controller method to perform save operation in brand module
    ...
    //function for deleting the brand from db
    ...
    public void exportToCSV(HttpServletResponse response) throws IOException{
        List<Brand> listUsers = brandservice.listAll();
